...
import type { JobBoardListing } from "../types/job-board.types";
...
export function JobBoardPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-50">
      ...
      <main className="mx-auto flex w-full max-w-[1200px] flex-col gap-10 px-5 pb-20 pt-[135px] sm:pt-[175px] lg:px-0">
        <div className="flex flex-col">
          <h1 className="text-[32px] leading-[1.2] text-black sm:text-[48px] sm:leading-[58px] sm:tracking-[-0.48px]">
            Find your next role
          </h1>
