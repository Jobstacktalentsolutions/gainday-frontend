...
// Optional direction the employer can give the generation model for a single-task regenerate —
// e.g. "focus more on stakeholder negotiation" — passed straight to the backend's
// GenerationService.regenerateTask, which prioritizes it over default variety.
        ...
        <Dialog.Root open={open} onOpenChange={(isOpen) => !isOpen && onCancel()}>
            <Dialog.Portal>
                ...
                >
                    ...
                    >
                        Anything specific you want this task to focus on? Optional — leave blank for a
                        fresh random task.
                    </Dialog.Description>

                    <div className="mt-6">
                        <FormTextarea
                            label="Direction for this task"
                            hideLabel
                            optional
                            rows={4}
                            placeholder="e.g. focus more on stakeholder negotiation..."
                            value={guidance}
