      ...
      <div className="mx-auto flex w-full max-w-[342px] flex-col gap-[43px]">
        <div className="flex flex-col gap-3">
          <button type="button" onClick={() => navigate(-1)} aria-label="Back">
            {/* ArrowLeft icon — reuse whatever's wired into JobDetailsStep */}
          </button>
          <div>
        ...
        {/* Shell only — this is an empty placeholder box in Figma as of today.
            Rebuild once Oluwatofunmi fills in the actual review content. */}
        <div className="flex min-h-[633px] w-full items-center justify-center rounded-3xl border border-dashed border-neutral-200 bg-white">
