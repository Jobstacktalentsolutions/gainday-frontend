...
const GradientCard = () => {
    return (
        <div className="relative min-w-80 lg:h-full lg:max-h-147 lg:pb-25 lg:pt-8.75  lg:px-14 overflow-hidden rounded-3xl bg-linear-to-b from-primary-500 via-primary-700 to-primary-800 p-4 shadow-2xl ">
